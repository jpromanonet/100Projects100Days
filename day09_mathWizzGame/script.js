function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
  ...
  render() {
    ...
    return (
      ...
      user && React.createElement("small", { className: "name" }, "Hello, ", user.name),
      user ?
      React.createElement("div", { className: "row" },
      React.createElement("div", { className: "col-1" },
      React.createElement("form", { className: "form", onSubmit: this.handleSubmit },
      React.createElement("h3", null, "Calculate:"),
      React.createElement("div", { className: "calculation" },
      React.createElement("p", { className: "op" }, nr1),
      React.createElement("p", { className: "op" }, sign),
      React.createElement("p", { className: "op" }, nr2),
      React.createElement("p", { className: "op" }, "="),
      ...
      React.createElement("span", null, user.name), " ", user.score)))))) :
      ...
      React.createElement("p", null, "Welcome to the Math Wizz game. ",
      React.createElement("br", null), "Let's test your math skills! \uD83D\uDE03 ",
      React.createElement("br", null),
      React.createElement("br", null), "You'll be given random math questions that you'll have to answer.",

      React.createElement("br", null), "Level changes when you reach the score of: 25, 50, 75..."),


      React.createElement("p", null, "Please enter your username to start:"),
