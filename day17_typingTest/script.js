function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
  ...
  render() {
    ...
    return (
      ...
      React.createElement("h2", null, "Welcome to the Typing game"),
      React.createElement("p", null,
      React.createElement("strong", null, "Rules:"), " ", React.createElement("br", null), "Type in the input field the highlighted word. ",
      React.createElement("br", null), "The correct words will turn ",
      React.createElement("span", { className: "green" }, "green"), ".",
      React.createElement("br", null), "Incorrect letters will turn ",
      React.createElement("span", { className: "red" }, "red"), ".",
      React.createElement("br", null),
      React.createElement("br", null), "Have fun! \uD83D\uDE03"),
    ...
    if (!text) return React.createElement("p", null, "Loading...");

    if (completed) {
      return (
        React.createElement("div", { className: "container" },
        React.createElement("h2", null, "Your WPM is ",
        React.createElement("strong", null, wpm)),

        React.createElement("button", { className: "start-btn", onClick: this.startGame }, "Play again"),
    ...
    return (
      ...
      React.createElement("div", { className: "wpm" },
      React.createElement("strong", null, "WPM: "),
      wpm,
      React.createElement("br", null),
      ...
      React.createElement("div", { className: "container" },
      React.createElement("h4", null, "Type the text below"),
